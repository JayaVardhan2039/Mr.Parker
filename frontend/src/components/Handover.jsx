    ...
    <div>
        ...
        <div className='flex gap-2 justify-between flex-col items-center'>
            <div className='w-full mt-5'>
                ...
                <button  className='w-full mt-5 bg-green-600 text-white font-semibold p-2 rounded-lg'>Payment</button>
                <button onClick={submitHandler} className='w-full mt-5 bg-green-600 text-white font-semibold p-2 rounded-lg'>Done</button>
            </div>
        </div>
    </div>
)
